...
def expense(request):
    ...
    return render(request, "components/management/expense.html", context)
...
def fee(request):
    ...
    return render(request, "components/management/fee.html", context)
...
def cashflow(request):
    ...
    return render(request, "components/management/cashflow.html", context)
